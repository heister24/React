...
//   return (
//     <div className="min-h-screen bg-gray-900 flex flex-col items-center p-10 gap-8">
...
//           className="px-4 py-2 rounded-lg bg-gray-800 text-white border border-gray-600 focus:border-blue-400 focus:outline-none"
//         />

//         <button
//           onClick={handleAdd}
//           className="bg-green-600 hover:bg-green-500 px-6 py-2 text-white font-semibold rounded-lg shadow"
//         >
//           Add
//         </button>
//       </div>
